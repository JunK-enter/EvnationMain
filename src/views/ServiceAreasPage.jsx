...
import { SERVICE_COUNTIES, getTotalCityCount } from '@/data/serviceAreasSeo'
import { useServiceAreasCopy } from '@/i18n/hooks/useExtraPages'

export default function ServiceAreasPage() {
  const totalCities = getTotalCityCount()
  const copy = useServiceAreasCopy(SERVICE_COUNTIES.length, totalCities)
      ...
      <section className="relative pt-28 pb-14 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-slate-400 mt-5 text-lg leading-relaxed max-w-3xl">{copy.subtitle}</p>
